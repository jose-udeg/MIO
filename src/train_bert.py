...
EPOCHS = 4
LR = 2e-5
FINE_TUNE_BERT = False                 # True para ajustar pesos de BERT (requiere GPU)
...
def main():
    ...
    enc = tokenizer(list(X_text.astype(str)), truncation=True, padding=True, max_length=MAX_LEN, return_tensors='np')
